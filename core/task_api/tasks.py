...
from core.config import INPUT_DIRECTORY
from core.extraction_modul.apis import TextStrategy, TableStrategy, MetadataStrategy, ImageStrategy
...
class Task:
    ...
    def execute_pdf_extraction(task_settings: TaskSettings) -> None:
        ...
        imageAPI.postprocess_data(data)
        metadataAPI.postprocess_data(data)
